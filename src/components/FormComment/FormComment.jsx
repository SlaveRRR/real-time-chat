        ...
        return (
            <form onClick={handleClick} className={classNames('form',...mixClass)} onSubmit={(e) => {
                ...
                <fieldset className="form__data">
                    ...
                    <input ref={usernameRef} value={data['author']} onChange={e => setData(prev => ({...prev,author:e.target.value}) )} className="form__name-input" placeholder="Slaver" type="text" id="nameAuthor"/>
                    <label className="form__comment" htmlFor="comment">Комментарий</label>
                    <textarea placeholder="Some text ..." value={data['text']} onChange={e => setData(prev => ({...prev,text:e.target.value}) )} className="form__textarea" id="comment" cols="30"
                        rows="3"></textarea>
                </fieldset>
                {
                    Boolean(parentId) &&  <fieldset  className="form__reaction-container">
                    ...
                    <label className="form__radio-btn-label" htmlFor="like">
                        ...
                        <input type="radio" className="hiddenBtn" name="reaction" value="1" onChange={e => setData(prev => ({...prev,reaction:e.target.value}) )} id="like"/>
                    </label>
                </fieldset>
                }
